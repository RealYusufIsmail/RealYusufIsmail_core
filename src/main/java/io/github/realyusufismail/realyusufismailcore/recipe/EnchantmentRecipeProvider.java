...
public class EnchantmentRecipeProvider {
    ...
    public EnchantmentRecipeProvider(IItemProvider pResult, int pCount) {
     ...
     */
    public static EnchantmentRecipeProvider shaped(IItemProvider pResult) {
     ...
     * Creates a new builder for a shaped recipe.
     */
    public static EnchantmentRecipeProvider shaped(IItemProvider pResult, int pCount) {
        return new EnchantmentRecipeProvider(pResult, pCount);
    }

    /**
     * Adds a key to the recipe pattern.
     */
    public EnchantmentRecipeProvider define(Character pSymbol, ITag<Item> pTag) {
     ...
     * Adds a key to the recipe pattern.
     */
    public EnchantmentRecipeProvider define(Character pSymbol, IItemProvider pItem) {
     ...
     * Adds a key to the recipe pattern.
     */
    public EnchantmentRecipeProvider define(Character pSymbol, Ingredient pIngredient) {
     ...
     */
    public EnchantmentRecipeProvider pattern(String pPattern) {
    ...
    public EnchantmentRecipeProvider unlockedBy(String p_200465_1_, ICriterionInstance p_200465_2_) {
        this.advancement.addCriterion(p_200465_1_, p_200465_2_);
        return this;
    }

    public EnchantmentRecipeProvider group(String p_200473_1_) {
    ...
    public void save(Consumer<IFinishedRecipe> p_200467_1_, ResourceLocation p_200467_2_) {
        ...
        p_200467_1_.accept(new Result(
                ...
                new ResourceLocation(
                        ...
                        "recipes/" + this.result.getItemCategory().getRecipeFolderName() + "/" + p_200467_2_.getPath()),
                enchantment,
                level,
                hideFlags));
    }
